...
class CReportCltPlayDlg : public CDialogEx
{
	DECLARE_DYNAMIC(CReportCltPlayDlg)
    DECLARE_EASYSIZE
public:
	CReportCltPlayDlg(CWnd* pParent = NULL);   // standard constructor
	virtual ~CReportCltPlayDlg();

// Dialog Data
	enum { IDD = IDD_REPORT_CLIENT_PLAY }; 
...
public:
    ...
    CMagicSortListCtrl m_ReportCltPlayList;
};
