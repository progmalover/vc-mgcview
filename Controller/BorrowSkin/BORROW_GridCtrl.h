...
#include "BORROW_InplaceToolTipCtrl.h"
#include "BORROW_InplaceEdit.h"
...
struct BORROW_DLLEXPORT BCGPGRID_ITEM_INFO
{
...
struct BORROW_DLLEXPORT BCGPGRID_NOTIFICATION	// used for BCGPGN_SELCHANGING, BCGPGN_SELCHANGED
{
	NMHDR	hdr;
...
struct BORROW_DLLEXPORT BCGPGRID_ITEM	// used for BCGPGN_GETDISPINFO
{
    int nRow;				// Row of an item
	int nCol;				// Column of an item
...
struct BORROW_DLLEXPORT BCGPGRID_DISPINFO
{
	NMHDR				hdr;
	BCGPGRID_ITEM		item;
};
...
class BORROW_DLLEXPORT CBCGPGridItemID
{
public:
...
class BORROW_DLLEXPORT CBCGPGridRange
{
public:
...
struct BORROW_DLLEXPORT BCGP_GRID_COLOR_DATA
{
	struct BORROW_DLLEXPORT ColorData
	{
...
class BORROW_DLLEXPORT CBCGPGridColors : public BCGP_GRID_COLOR_DATA
{
public:
	CBCGPGridColors ()
	{
...
struct BORROW_DLLEXPORT BCGP_GRID_FINDREPLACE_PARAM 
{
public:
...
class BORROW_DLLEXPORT CBCGPGridRow : public CObject
{
...
class BORROW_DLLEXPORT CBCGPGridItem : public CObject
{
...
// Attributes methods
	...
	virtual void EmptyValue (BOOL bRedraw = TRUE);
...
class BORROW_DLLEXPORT CBCGPGridColorItem : public CBCGPGridItem
{
	friend class CBCGPGridCtrl;
	friend class CBCGPGridRow;
...
class BORROW_DLLEXPORT CBCGPGridDateTimeItem : public CBCGPGridItem
{
...
class BORROW_DLLEXPORT CBCGPGridCheckItem : public CBCGPGridItem
{
...
class BORROW_DLLEXPORT CBCGPGridURLItem : public CBCGPGridItem
{
...
struct BORROW_DLLEXPORT BCGP_GRID_FILTER_PARAM
{
	// Construction
...
struct BORROW_DLLEXPORT BCGP_GRID_FILTERBAR_PARAM
{
	// Construction
...
class BORROW_DLLEXPORT CBCGPGridFilterEdit : public CBCGPEdit
{
...
class BORROW_DLLEXPORT CBCGPGridMergedCells : public CObject
{
// Construction:
public:
...
class BORROW_DLLEXPORT CBCGPGridHeaderParams
{
public:
...
public:
	...
	DWORD m_dwData;	// Reserved for custom data
};

/////////////////////////////////////////////////////////////////////////////
// CBCGPGridColumnsItem object

class BORROW_DLLEXPORT CBCGPGridColumnsItem : public CObject
{
...
public:
	CBCGPGridColumnsItem (LPCTSTR lpszColumn, int nWidth, int iImage = -1)
		...
		m_bLocked (FALSE), m_bText (TRUE), m_nAutoSize (0), m_pFilterBarCtrl (NULL), m_bCanSort(true)
	{
	}
...
class BORROW_DLLEXPORT CBCGPGridColumnsInfo : public CObject
{
	friend class CBCGPGridRow;
	friend class CBCGPGridCtrl;
...
public:
	...
	BOOL GetColumnCanSort (int nColumn) const;
	BOOL SetColumnCanSort (int nColumn, BOOL bCanSort);
...
class BORROW_DLLEXPORT CBCGPGridPage : public CObject
{
public:
...
struct BORROW_DLLEXPORT CBCGPGridPageInfo
{
...
struct BORROW_DLLEXPORT CBCGPGridCachePageInfo
{
...
class BORROW_DLLEXPORT CBCGPGridCache : public CObject
{
	friend class CBCGPGridCtrl;
...
class BORROW_DLLEXPORT CBCGPGridCtrlDropTarget : public COleDropTarget
{
public:
...
BORROW_DLLEXPORT extern UINT BCGM_GRID_ITEM_CHANGED;
BORROW_DLLEXPORT extern UINT BCGM_GRID_ITEM_BEGININPLACEEDIT;
BORROW_DLLEXPORT extern UINT BCGM_GRID_ITEM_ENDINPLACEEDIT;
BORROW_DLLEXPORT extern UINT BCGM_GRID_SEL_CHANGED;
BORROW_DLLEXPORT extern UINT BCGM_GRID_ITEM_DBLCLICK;
BORROW_DLLEXPORT extern UINT BCGM_GRID_ON_HIDE_COLUMNCHOOSER;
BORROW_DLLEXPORT extern UINT BCGM_GRID_BEGINDRAG;
BORROW_DLLEXPORT extern UINT BCGM_GRID_COLUMN_CLICK;
BORROW_DLLEXPORT extern UINT BCGM_GRID_ADJUST_LAYOUT;
BORROW_DLLEXPORT extern UINT BCGM_GRID_FIND_RESULT;
...
class BORROW_DLLEXPORT CBCGPGridCtrl : public CWnd
{
...
public:
	...
	COLORREF GetGroupTextColor () const
	{
		...
		(m_bHighlightGroups ? 
			(m_bControlBarColors ? afxGlobalData.clrBarShadow : afxGlobalData.clrBtnShadow) :
	...
	void SetScrollBarsStyle (CBORROW_ScrollBar::BORROW_SB_STYLE style)
	{
	...
	CBORROW_ScrollBar::BORROW_SB_STYLE GetScrollBarsStyle () const
	{
...
protected:
	...
	CBORROW_ScrollBar	    m_wndScrollVert;		// Vertical scroll bar
	CBORROW_ScrollBar	    m_wndScrollHorz;		// Horizontal scroll bar
	...
	CBORROW_ScrollBar::BORROW_SB_STYLE 
	...
	CBorrow_Button				m_btnFilterClear;
...
public:
	...
	BOOL GetColumnCanSort(int nCol) const;
	BOOL SetColumnCanSort (int nCol, BOOL bCanSort = TRUE);
...
protected:
	...
	virtual int GetLeftMarginWidth () const { return m_nRowHeight; }
