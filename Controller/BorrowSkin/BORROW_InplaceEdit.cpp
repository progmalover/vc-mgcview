...
CBORROW_InplaceEdit::CBORROW_InplaceEdit()
{
...
BEGIN_MESSAGE_MAP(CBORROW_InplaceEdit, CEdit)
	//{{AFX_MSG_MAP(CBORROW_InplaceEdit)
...
/////////////////////////////////////////////////////////////////////////////
// CBORROW_InplaceEdit message handlers

void CBORROW_InplaceEdit::OnUpdateR() 
{
	ResizeEditor ();
}
//*******************************************************************************
int CBORROW_InplaceEdit::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
//*******************************************************************************
LRESULT CBORROW_InplaceEdit::OnSetText (WPARAM, LPARAM)
{
...
//*******************************************************************************
void CBORROW_InplaceEdit::ResizeEditor ()
{
	ASSERT_VALID (this);
