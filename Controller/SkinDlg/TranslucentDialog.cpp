...
void CTranslucentDialog::DrawCaptionTitle(Gdiplus::Graphics& graph)
{
    CString title;
    GetTitle(title);
    ...
    Gdiplus::Font msgFont(ncm.lfCaptionFont.lfFaceName, 15, Gdiplus::FontStyleRegular, Gdiplus::UnitPixel);
    Gdiplus::SolidBrush msgBrush( Gdiplus::Color(0xBD, 0xCA, 0xD8) );
    Gdiplus::StringFormat stringFormat;
    stringFormat.SetAlignment(Gdiplus::StringAlignmentNear);

    graph.DrawString( title.GetString(), -1,
        &msgFont, Gdiplus::RectF(12.0f, 6.0f, 280.0f, 28.0f),
