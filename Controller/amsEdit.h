...
#define AMSEDIT_ALL_CLASSES			(AMSEDIT_ALPHANUMERIC_CLASS | AMSEDIT_MASKED_CLASS | AMSEDIT_NUMERIC_CLASS|AMSEDIT_INTEGER_CLASS | AMSEDIT_CURRENCY_CLASS | AMSEDIT_DATETIME_CLASS)
...
// 			#endif
			...
			typedef int (*ValidationFunction)(TCHAR);		
			typedef TCHAR (*ConversionFunction)(TCHAR);		
