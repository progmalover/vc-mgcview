						   ...
						   UINT nID)
{
    ...
    results = this->CreateControl(CLSID_WebBrowser,
                                           NULL,
    ...
    LPUNKNOWN unknown = this->GetControlUnknown();
...
CString SimpleBrowser::GetProperty(CString Name)
{
	VARIANT vProperty;

	_Browser->GetProperty(Name.AllocSysString(), &vProperty);
	return _T("");
}
